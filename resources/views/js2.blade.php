    ...
    <head>
        ...
        <script>
            function form_validation(){
                ...
                if (nrp.length ==0) //harus ada isinya
                ...
                if (nama.length ==0) //harus ada isinya
        ...
        <div class="container">
            ...
            <form id="frmpendaftaran" action="https://google.co.id" method="get" onsubmit="return form_validation();">
                NRP: <input type="text" id="nrp" class="form-control"
                    placeholder="Silahkan Isi NRP, 10 digit, harus angka, gak boleh kosong" name="nrp" >
                <br>
                Nama: <input type="text" id="nama" class="form-control"
                placeholder="Silahkan Isi Nama, minim 1 digit, harus angka, gak boleh kosong" name="nama" >
                <br>
